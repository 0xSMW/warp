...
use warpui::elements::{
    ChildView, CornerRadius, CrossAxisAlignment, DEFAULT_UI_LINE_HEIGHT_RATIO, Flex, Hoverable,
...
impl EditorView {
    ...
    fn render_controls(&self, _ctx: &AppContext) -> Option<Box<dyn Element>> {
        // Commented out: Editor controls (voice input, image attachment, @ AI context menu)
        None
    }
}
