...
// Commented out for local-only production builds; retained for output unit tests.
#[cfg(test)]
...
// Commented out: cloud Agent CLI raw JSON streaming and filtering are disabled in local-only mode.
/*
