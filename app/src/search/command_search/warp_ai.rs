...
/// The Warp AI data source provides the synchronous UI result for Warp AI.
///
/// Its asynchronous side remains registered for mixer compatibility but is inert so command
/// search does not invoke the cloud AI client.
...
impl WarpAIDataSource {
    pub fn new(
        ...
        let _ = (ai_client, ai_execution_context);
        Self
    }
}
